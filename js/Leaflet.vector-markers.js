  ...
  (function(window, document, undefined_) {
    ...
    L.VectorMarkers.Icon = L.Icon.extend({
      ...
      createIcon: function(oldIcon) {
        ...
        div.innerHTML = '<svg width="16px" height="26px" viewBox="0 0 32 52" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">' + '<path d="' + pin_path + '" fill="' + options.markerColor + '"></path>' + icon + '</svg>';
